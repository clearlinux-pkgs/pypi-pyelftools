...
Source0  : https://files.pythonhosted.org/packages/b9/ab/33968940b2deb3d92f5b146bc6d4009a5f95d1d06c148ea2f9ee965071af/pyelftools-0.32.tar.gz
...
%prep
%setup -q -n pyelftools-0.32
cd %{_builddir}/pyelftools-0.32
pushd ..
cp -a pyelftools-0.32 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739976714
